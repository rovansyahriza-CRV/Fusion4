...
-- Catatan: Disable trigger USER sementara agar tidak menyentuh system trigger (RI_ConstraintTrigger)
ALTER TABLE "karyawanTbl" DISABLE TRIGGER USER;
...
ALTER TABLE "karyawanTbl" ENABLE TRIGGER USER;
